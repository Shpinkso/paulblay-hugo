...
banner = "img/banners/product_outcomes-bad.jpg"
authors = ["Paul Blay"]
+++
...
More "putting ideas to real world use" here. How does our new OKR stack up against the criteria in the [OKR Scorecard](https://paulblay.com/blog/2021/04/05/the-okr-scorecard/)?

#### Objective

| Factor | Voted Average Score |
| ---- | ---- |
| Is Inspiring to me | 5 |
| Represents an important impact | 7 |
| I understand why | 10 |
| **Sum** | **22** |
...
| ---- | ---- | ---- |
| Represents value for the business | Direct Value | 2 |
| Defines | Where | 1 |
...
| ---- | ---- | ---- |
| Is numerical | Yes | 2 |
| Measurability | Could be measured with some work | 1 |
| Represents a change in customer behaviour | Yes | 2 |
| Likely distribution of movement over OKR lifetime | Even distribution | 2 |
| Multiple paths to achievement | Yes | 1 | 
...
| ---- | ---- | ---- |
| Is numerical | Yes | 2 |
| Measurability | Is measurable now | 2 |
| Represents a change in customer behaviour | Yes | 2 |
| Likely distribution of movement over OKR lifetime | Front/back loaded | 0.5 |
| Multiple paths to achievement | Yes | 1 | 
